...
const CountryCard = ({ country,loading }) => {
  ...
  return (
    <div
      onClick={() => router.push(`/overview/${country.code}`)}
    ...
    >
      {!loading ? (
        ...
        <div className='flex items-center gap-5'>      <div className='h-[56px] w-[56px] text-[48px] flex items-center ' >{country?.flag}</div>
        <div className='flex flex-col justify-center'>      <p className="text-base  font-medium leading-normal text-black">{country?.name}</p>
